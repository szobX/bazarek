  ...
  <footer class="text-gray-700 body-font">
      ...
      <div class="flex flex-wrap md:text-left text-center order-first">
        ...
        <div class="lg:w-1/4 md:w-1/2 w-full px-4">
          ...
          >
            ...
            <button
              class="lg:mt-2 xl:mt-2 mt-4 flex-shrink-0 inline-flex text-white bg-green-500 border-0 py-2 px-6 focus:outline-none hover:bg-green-600 rounded"
            >
              Zapisz się
            </button>
          </div>
          <p class="text-gray-500 text-sm mt-2 md:text-left text-center">
            Lorem ipsum ....
            <br class="lg:block hidden" />Lorem ipsum...
          </p>
        </div>
      </div>
    </div>
    <div class="bg-green-600 text-white">
      ...
      >
        ...
        >
          <span class="ml-3 text-xl">bazarek</span>
        </a>
